...
// Buzhash parameters, fixed exactly as in boxo/chunker.
const (
	buzMin  = 128 << 10
	buzMax  = 512 << 10
	buzMask = 1<<17 - 1
...
func (b *Buzhash) Reader() io.Reader { return b.reader }

// bytehash is github.com/ipfs/boxo/chunker's buzhash table, copied verbatim
// from chunker/buzhash.go (generated by that package's gen/main.go).
