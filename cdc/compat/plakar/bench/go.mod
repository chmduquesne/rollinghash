// Nested module: pulls github.com/PlakarKorp/go-cdc-chunkers for head-to-head
// parity tests and benchmarks, plus github.com/PlakarKorp/kloset (plakar's
// backup library, and its whole dependency graph) for one end-to-end backup
// parity test. Kept separate so the main rollinghash module stays
// dependency-free. kloset needs a recent Go toolchain, which `go` fetches
