...
// look at cdc/compat/plakar/bench/keyed_test.go, function plakarKeyedGearTable
package fastcdc
...
func (f *fcCut) Lookback() int { return 64 }
...
// keeps it in the current one. cuttingwindow clamps the result to len(avail).
